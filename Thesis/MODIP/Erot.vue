...
export default {
    ...
    methods: {
      ...
      addErot(newErot,question, sans, type, date,tmima,idrima) {
        
      axios.post('http://83.212.17.131/nikos/restApi/api/erot/create.php', { title: newErot , question: question, answers: sans, type: type, date:date, tmima: tmima, idrima:idrima, crby:this.uid})
